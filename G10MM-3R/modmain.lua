...
-- 采集范围
GLOBAL.ROBOBEE_SEE_OBJECT_DIST = GetModConfigData("robobeerangeconfig")
GLOBAL.ROBOBEE_KEEP_PICKING_DIST = GetModConfigData("robobeerangeconfig")

if GetModConfigData("robobeeclosebuzzconfig") == 1 then
	RemapSoundEvent("robobeesounds/robobeesounds/sleep", "")
end
